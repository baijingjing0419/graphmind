...
def parse_mongodb_uri(mongodb_uri: str) -> Tuple[str, str]:
    ...
    Args:
        mongodb_uri: MongoDB连接字符串，例如：
            - mongodb://localhost:27017/graphmind
            - mongodb://user:pass@localhost:27017/graphmind?authSource=admin
    ...
    # 如果没有数据库名称，使用默认值
    if not db_name:
        db_name = os.getenv("MONGODB_DB_NAME", "graphmind")
    ...
    def __init__(self, connection_string: Optional[str] = None):
        ...
        if connection_string:
            ...
            if mongodb_uri and mongodb_uri.strip():
                ...
                self.db_name = os.getenv("MONGODB_DB_NAME", "graphmind")
